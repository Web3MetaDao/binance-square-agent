...
export REFERRAL_CODE="your_binance_referral_code"
export REFERRAL_LINK="https://www.binance.com/zh-CN/join?ref=YOUR_CODE"
```

### 3. 进入项目目录

```bash
cd /home/ubuntu/clawself_agent
```
...
| LLM_MODEL | gpt-4.1-mini | 使用的LLM模型 |
